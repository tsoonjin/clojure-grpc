...
2. Go to [localhost:8080](http://localhost:8080/) to see: `Hello from demo-server, backed by Protojure Template! `
...
If you then update the `require` block of demo-server/service.clj to use these generated clojure
